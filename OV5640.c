...
static struct reg_value ov5640_setting_30fps_1280_960_HFOV29[] = {
    ...
    {0x380e, 0x03}, {0x380f, 0xd8}, // Total vertical size  =  0x3d8   ()
    {0x3810, 0x00}, {0x3811, 0x10}, // ISP horizontal offset = 0x2a3
    {0x3812, 0x00}, {0x3813, 0x04}, // ISP vertical   offset = 0x1ef
    {0x3618, 0x00}, {0x3612, 0x29}, {0x3708, 0x64},
    {0x3709, 0x52}, {0x370c, 0x03}, {0x3a02, 0x02},
    {0x3a03, 0xe4}, {0x3a08, 0x01}, {0x3a09, 0xbc},
    {0x3a0a, 0x01}, {0x3a0b, 0x72}, {0x3a0e, 0x01},
...
static BOOL initCamera (PCAM_HW_INDEP_INFO pInfo, BOOL fullInit, CAM_NO cam)
{
    ...
    ret = DoI2CWrite(pInfo, ov5640_setting_30fps_1280_960_HFOV29, dim(ov5640_setting_30fps_1280_960_HFOV29), cam);
